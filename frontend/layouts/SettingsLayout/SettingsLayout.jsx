...
function SettingsLayout({titulo, onVoltar, children, rodape, testeId = 'settings-layout'}) {
    ...
    return (
        <SafeAreaView testID={testeId} edges={['bottom']} style={estilos.container}>
            <Header titulo={titulo} variante="comVoltar" onVoltar={onVoltar} />

            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={estilos.areaInterativa}>
                <ScrollView
